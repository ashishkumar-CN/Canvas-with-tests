...
const ShopSidebar = () => {
    try {
            ...
            <div className="space-y-8">
                ...
                <div>
                    ...
                    <div className="flex items-center justify-between text-sm font-medium">
                        ...
                        <span>₹{(priceRange?.[1] || 50000).toLocaleString()}</span>
                    </div>
        ...
        return <div className="p-4 border border-dashed rounded-lg text-xs text-muted-foreground uppercase tracking-widest text-center">Sidebar filter currently unavailable</div>;
    }
};
